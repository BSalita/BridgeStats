...
st.caption("Project lead is Robert Salita research@AiPolice.org. Code written in Python. UI written in Streamlit. Self-hosted using Ubuntu and Cloudflare Tunnel.")
