...
st.caption("Project lead is Robert Salita research@AiPolice.org. Code written in Python. UI written in Streamlit. Self-hosted using Cloudflare Tunnel on Ubuntu.")
